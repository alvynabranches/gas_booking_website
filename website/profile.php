...
<head>
    ...
    <?php include_once("config.php");redirect('profile.php','agency-home.php','index.php');?>
</head>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link border rounded btn-primary btn-rounded" data-toggle="dropdown" aria-expanded="false" data-bs-hover-animate="wobble" href="" style="color: #ffffff;font-weight: bold;" name="username-container">Username</a>
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="">Profile</a><a class="dropdown-item" role="presentation" href="profile.php?action=logout">Logout<?php include_once("config.php");logout_user();redirect('user.php','agency-home.php','login.php');?></a></div>
                    </li>
                </ul>
            </div>
        </div>
