    ...
    <div class="scroller">
        <div class="form-div container-fluid h-100">
            <form>
                ...
                <div class="form-group"><select class="form-control" name="location"><option value="" selected="" disabled>Location</option><?php include_once('config.php');echo location_options() ?></select></div>
