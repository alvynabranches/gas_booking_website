            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-hover-animate="flash" style="color: #ffffff;font-weight: bold;" href="contact-us.php">Contact Us</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" role="menu">
                            ...
                            <a class="dropdown-item active" role="presentation" href="user-settings.php">Settings</a>
                            <a class="dropdown-item" role="presentation" href="user-settings.php?action=logout">Logout<?php include_once("config.php");logout();redirect('index.php','','agency-home.php');?></a>
                        </div>
                    </li>
                </ul>
            </div>
