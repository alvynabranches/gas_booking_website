...
<head>
    ...
    <?php include_once("config.php");redirect('user-settings.php','agency-home.php','index.php');?>
</head>
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link btn-primary" data-toggle="dropdown" aria-expanded="false" data-bs-hover-animate="wobble" href="" style="color: #ffffff;font-weight: bold;" name="username-container"><?php include_once('config.php');if(isset($_SESSION['username'])){echo $_SESSION['username'];}else{echo 'username';}?></a>
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="user.php">Profile</a><a class="dropdown-item" role="presentation" href="user-booking.php">Booking</a><a class="dropdown-item" role="presentation" href="user-order-status.php">Order Status</a>
                            <a class="dropdown-item" role="presentation" href="user-change-password.php">Change Password</a><a class="dropdown-item active" role="presentation" href="user-settings.php">Settings</a><a class="dropdown-item" role="presentation" href="user-settings.php?action=logout">Logout<?php include_once("config.php");logout_user();redirect('user.php','agency-home.php','index.php');?></a></div>
                    </li>
                </ul>
        </div>
        </div>
    ...
    <div class="scroller">
        <div class="details-div container-fluid h-100">
            <form method="POST">
                ...
                <div class="form-group"><input class="form-control" type="text" name="name" placeholder="Name" value="<?php include_once('config.php');if(isset($_SESSION['username'])){echo $_SESSION['name'];}?>"></div>
                ...
                <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password" autocomplete></div>
                ...
                <?php include_once('config.php');change_details();?>
            </form>
        </div>
    </div>
