<?php
    ...
    function redirect(string $redirect_customer_page, string $redirect_agency_page, string $index_page='index.php'){if(!isset($_COOKIE['PHPSESSID'])){session_start();}if($_SESSION==null){header("Location: $index_page");}else{if($_SESSION['user_type']=='customer'){header("Location: $redirect_customer_page");}else if($_SESSION['user_type']=='agency'){header("Location: $redirect_agency_page");}else{session_unset();header("Location: $index_page");}}}
            ...
            if(password_verify($pwd, $db_pwd)){
                if(($new_name!=$name)&&($new_phone!=$phone)&&($new_address!=$address)){
                    if(exec_query("UPDATE customer SET customer_name='$new_name', customer_no='$new_phone', customer_address='$new_address' WHERE customer_id='$id';")===TRUE){
                        ...
                        $_SESSION['phone_no']=$new_phone;
                        $_SESSION['address']=$new_address;
                        if(DEBUG){console_log("Successfully Updated Customer Name, Customer Phone No. and Customer Address!");}
                        alert("Successfully Updated Customer Name, Customer Phone No. and Customer Address!");
                    }else{
                        if(DEBUG){console_log("Unsuccessfully Updated Customer Name, Customer Phone No. and Customer Address!");
                ...
                if(exec_query("UPDATE customer SET customer_name='$new_name', customer_no='$new_phone' WHERE customer_id='$id';")){
                    $_SESSION['name']=$new_name;$_SESSION['phone_no']=$new_phone;
                    if(DEBUG){
                        console_log("Successfully Updated Customer Name and Customer Phone No.!");
                    }alert("Successfully Updated Customer Name and Customer Phone No.!");
                }else{if(DEBUG){console_log("Unsuccessfully Updated Customer Name and Customer Phone No.!");
                }alert("Unsuccessfully Updated Customer Name and Customer Phone No.!");}}elseif(($new_name!=$name)&&($new_phone==$phone)&&($new_address!=$address)){
                    if(exec_query("UPDATE customer SET customer_name='$new_name', customer_address='$new_address' WHERE customer_id='$id';")){
                        $_SESSION['name']=$new_name;$_SESSION['address']=$new_address;
                        if(DEBUG){console_log("Successfully Updated Customer Name and Customer Address!");}
                        alert("Successfully Updated Customer Name and Customer Address!");
                    }else{if(DEBUG){console_log("Unsuccessfully Updated Customer Name and Customer Address!");
                    ...
                    if(exec_query("UPDATE customer SET customer_no='$new_phone' customer_address='$new_address' WHERE customer_id='$id';")){
                        $_SESSION['phone_no']=$new_phone;$_SESSION['address']=$new_address;
                        if(DEBUG){console_log("Successfully Updated Customer Phone No. and Customer Address!");}
                        alert("Successfully Updated Customer Phone No. and Customer Address!");
                    }else{if(DEBUG){console_log("Unsuccessfully Updated Customer Phone No. and Customer Address!");}
                    ...
                    if(exec_query("UPDATE customer SET customer_name='$new_name' WHERE customer_id='$id';")){
                        $_SESSION['name']=$new_name;if(DEBUG){
                            console_log("Successfully Updated Customer Name!");}alert("Successfully Updated Customer Name!");}
                            else{if(DEBUG){console_log("Unsuccessfully Updated Customer Name!");
                            }alert("Unsuccessfully Updated Customer Name!");
                        }}elseif(($new_name==$name)&&($new_phone!=$phone)&&($new_address==$address)){
                            if(exec_query("UPDATE customer SET customer_no='$new_phone' WHERE customer_id='$id';")){
                                $_SESSION['phone_no']=$new_phone;
                                if(DEBUG){console_log("Successfully Updated Customer Phone No.!");}
                                alert("Successfully Updated Customer Phone No.!");
                            }else{if(DEBUG){console_log("Unsuccessfully Updated Customer Phone No.!");}
                            ...
                            if(exec_query("UPDATE customer SET customer_address='$new_address' WHERE customer_id='$id';")){
                                $_SESSION['address']=$new_address;
                                if(DEBUG){console_log("Successfully Updated Customer Address!");}
                                alert("Successfully Updated Customer Address!");
                            }else{
                                if(DEBUG){console_log("Unsuccessfully Updated Customer Address!");}
                                alert("Unsuccessfully Updated Customer Address!");
                            }}else{if(DEBUG){console_log("Everything is up to date!");}
                            alert("Everything is up to date!");
                            redirect("user.php",'agency.php','index.php');
                        }}else{alert("Password does not match!");
                            console_log("Password does not match!");
