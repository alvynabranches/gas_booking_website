...
<head>
    ...
    <?php include_once("config.php");redirect('','user.php','agency-home.php');?>
</head>
...
<img class="img-fluid mx-auto d-block img-thumbnail p-10" src="assets/img/11.jpg" alt="Burner Image" loading="auto" width="950" style="filter: blur(0px) brightness(75%) contrast(100%) grayscale(10%) hue-rotate(60deg) invert(10%) saturate(200%) sepia(0%);padding:10px;@media (max-height:700px){padding-top:20px;}">
